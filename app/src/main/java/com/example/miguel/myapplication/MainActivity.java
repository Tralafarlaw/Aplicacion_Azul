...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,LocationListener {
    ...
    //Permisos write and read
    private void setUpWR() {

            Log.d(TAG, "Verificando permisos :u");
...
*/
    ...
    private void checkPermissions(){
        ...
        int permissionRead = ContextCompat.checkSelfPermission(MainActivity.this,
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        ...
        if (permissionLocation == PackageManager.PERMISSION_GRANTED && permissionRead == PackageManager.PERMISSION_GRANTED && permissionWrite == PackageManager.PERMISSION_GRANTED) {
            getMyLocation();
        }
        //setUpWR();
    }
